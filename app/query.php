...
const QUERIES = [
    ...
    "add_location" => "INSERT INTO location (name) VALUES (?)",
    "add_device" => "INSERT INTO device (name) VALUES (?)",
    "search_location" => "SELECT * FROM location WHERE name = ?",
    "search_device" => "SELECT * FROM device WHERE name = ?",
    ...
    "get_location_posts" => "SELECT p.post_id, p.caption, p.`timestamp`, p.username AS owner, pl.username, pr.username AS rated FROM post p LEFT JOIN post_like pl ON p.post_id = pl.post_id AND pl.username = ? LEFT JOIN post_rating pr ON p.post_id = pr.post_id AND pr.username = ? WHERE p.location = ? ORDER BY p.`timestamp` DESC LIMIT ?, ?",
    "get_device_posts" => "SELECT p.post_id, p.caption, p.`timestamp`, p.username AS owner, pl.username, pr.username AS rated FROM post p LEFT JOIN post_like pl ON p.post_id = pl.post_id AND pl.username = ? LEFT JOIN post_rating pr ON p.post_id = pr.post_id AND pr.username = ? WHERE p.device = ? ORDER BY p.`timestamp` DESC LIMIT ?, ?",
    ...
    "get_matching_locations" => "SELECT name FROM location WHERE name LIKE ?",
    "get_matching_devices" => "SELECT name FROM device WHERE name LIKE ?",
