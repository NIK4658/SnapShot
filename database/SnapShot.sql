...
--
-- Host: localhost:3306
-- Generation Time: Feb 13, 2023 at 09:11 PM
...
ALTER TABLE `post`
  ...
  ADD KEY `FK_post_location` (`location`),
  ADD KEY `FK_post_device` (`device`);
...
--
ALTER TABLE `post`
  ADD CONSTRAINT `FK_post_device` FOREIGN KEY (`device`) REFERENCES `device` (`name`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_post_location` FOREIGN KEY (`location`) REFERENCES `location` (`name`) ON DELETE CASCADE ON UPDATE CASCADE,
